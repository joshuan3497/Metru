...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        $sql_resumen = "SELECT 
            ...
            d.cantidad_devuelta as regresaron,
            (ds.cantidad - COALESCE(SUM(df.cantidad), 0)) - COALESCE(d.cantidad_devuelta, 0) as diferencia
        ...
        LEFT JOIN devoluciones d ON d.producto_id = p.id AND d.salida_id = ?
        WHERE ds.salida_id = ?
        GROUP BY p.id, ds.cantidad, d.cantidad_devuelta
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <input type="number" 
                                   class="form-control form-control-sm text-center cantidad-regresada" 
