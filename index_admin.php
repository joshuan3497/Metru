...
$sql_rutas_dia = "SELECT 
    r.nombre as ruta_nombre,
    s.estado,
    u.nombre as responsable,
    s.fecha_salida,
    s.id as salida_id,
    COUNT(ds.id) as productos_salida,
...
$rutas_dia = obtenerRegistros($sql_rutas_dia, [$fecha_hoy]);
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo $rutas_activas; ?>
                        </div>
                        <small class="text-muted">
                            de <?php echo $total_salidas; ?> programadas
                        </small>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-8 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary"><?php echo count($rutas_dia); ?> rutas</span>
            </div>
            <div class="card-body">
